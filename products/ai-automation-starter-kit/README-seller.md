# Satıcı Talimatı — AI Automation Starter Kit
...
## Ödeme
- Gumroad → Settings → Payments → **Payoneer veya banka hesabını** bağla.
- Türkiye'de Stripe/PayPal yok; Payoneer ana ray.

## Yayın sonrası (ben yazarım, sen paylaşırsın)
- Ürün linkini bana ver → 3-5 tanıtım gönderisi + 2-3 topluluk paylaşımı
  metni hazırlarım.
